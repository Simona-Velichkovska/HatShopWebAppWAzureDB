...
namespace HatShopWebAppWAzureDB.Migrations
{
    ...
    [Migration("20230403115724_CartItemsRemovedTotal")]
    partial class CartItemsRemovedTotal
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HatShopWebAppWAzureDB.Identity.User", b =>
                {
            ...
            modelBuilder.Entity("HatShopWebAppWAzureDB.Models.Domain.CartItems", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("HatShopWebAppWAzureDB.Models.Domain.CartItems", b =>
                {
                    b.HasOne("HatShopWebAppWAzureDB.Models.Domain.Hat", "Hat")
                        .WithMany()
                        .HasForeignKey("HatId")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("HatShopWebAppWAzureDB.Identity.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
